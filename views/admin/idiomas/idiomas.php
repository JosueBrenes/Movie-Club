                        ...
                        <?php while ($row = oci_fetch_assoc($cursor)): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="eliminar_idioma.php?id=<?php echo htmlspecialchars($row['ID_IDIOMAS'], ENT_QUOTES); ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este idioma?');">Eliminar</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
