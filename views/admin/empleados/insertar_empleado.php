...
$sql = 'INSERT INTO FIDE_EMPLEADOS_TB (ID_EMPLEADO, NOMBRE, APELLIDO, CORREO_ELECTRONICO, TELEFONO, ID_POSICION) 
        VALUES (:id_empleado, :nombre, :apellido, :correo, :telefono, :id_posicion)';
